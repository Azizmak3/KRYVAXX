...
const UseCaseExplorer: React.FC = () => {
  ...
  return (
    <section id="cases" className="py-32 px-6 bg-black text-white border-b-4 border-blue-600">
      <div className="max-w-[1440px] mx-auto space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-0 border-4 border-white">
          {/* Header Block */}
          <div className="lg:col-span-12 p-10 sm:p-16 border-b-4 border-white bg-zinc-900">
            <h2 className="text-4xl sm:text-6xl font-black uppercase tracking-tighter text-white mb-6 leading-tight">
              {t.case.header}
            </h2>
            <div className="space-y-4 text-xl font-medium text-gray-300 max-w-4xl">
              ...
              <div className="pt-8 text-2xl text-white italic font-serif leading-relaxed">
                {t.case.quote}
              </div>
            </div>
          </div>
          ...
          {/* Systems Column */}
          <div className="lg:col-span-7 p-10 sm:p-16 border-b-4 lg:border-b-0 lg:border-r-4 border-white bg-black">
            <div className="space-y-12">
              <div className="flex items-center space-x-4 text-blue-500">
                <Layers className="w-8 h-8" />
                <h3 className="text-2xl font-black uppercase tracking-widest">{t.case.systems.title}</h3>
              </div>
              
              <div className="space-y-10 font-mono">
                {[t.case.systems.s1, t.case.systems.s2, t.case.systems.s3].map((sys, i) => (
                  <div key={i} className="space-y-2">
                    <div className="text-lg font-bold text-white uppercase border-l-4 border-blue-600 pl-4">{sys.t}</div>
          ...
          {/* Metrics Column */}
          <div className="lg:col-span-5 p-10 sm:p-16 bg-zinc-900 flex flex-col justify-between">
            <div className="space-y-12">
               <div className="flex items-center space-x-4 text-green-500">
                <Activity className="w-8 h-8" />
                <h3 className="text-2xl font-black uppercase tracking-widest">{t.case.metrics.title}</h3>
              </div>
            ...
            <div className="mt-12 pt-8 border-t-2 border-zinc-700">
              <div className="text-2xl font-black text-white uppercase leading-tight tracking-tight">
                {t.case.metrics.roi}
              </div>
              <div className="mt-8">
